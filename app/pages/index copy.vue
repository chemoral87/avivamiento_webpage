<template>
  <v-app>
    ...
    <v-main class="pa-0">
        ...
        <v-container>
          ...
          <v-row justify="center">
            <v-col cols="12" sm="6" md="6">
              <v-card class="text-center pa-3  pastor-card" elevation="0" >
          ...
          <v-col cols="12" sm="5" md="5">
            <div class="pa-4">
              ...
              <div class="mb-6">
                ...
                <p class="text-body-2" style="color: #555;">
              ...
              <div class="mb-8">
                ...
                <p class="text-body-2" style="word-break: break-all;">
      ...
      <!-- Footer -->
      <v-footer style="background-color: transparent; color: white;" class="py-4">
      <v-container>
        <v-row>
