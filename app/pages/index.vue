<template>
  <v-app>
    ...
    <v-main class="pa-0">
      ...
      <v-container fluid class="hero-section pa-0" style="margin-top: -70px;">
        <v-img
          ...
          :height="isMobile ? '60vh' : 'calc(100vh + 70px)'"
          cover
      ...
      <v-container class="py-8">
        ...
        <v-row justify="center">
          <v-col cols="12" md="5">
            <v-card elevation="0" class="text-center pa-8" style="border: 1px solid #e0e0e0;">
      ...
      <!-- Horarios Section -->
      <v-container fluid id="horarios" class="py-8" style="background-color: #f8f9fa;">
        <v-container>
          <v-row>
      ...
      <v-container id="ubicacion" class="py-8">
        <v-row>
          <v-col cols="12" class="text-center">
          ...
          <v-col cols="12" md="5">
            <div class="pa-6">
              ...
              <div class="mb-6">
                ...
                <p class="text-body-1">
                  <a href="tel:+528112345678" class="text-decoration-none" style="color: #041845;">
                    +52 (81) 1234-5678
                  </a>
                </p>
              </div>
      ...
      <!-- Contacto Section -->
      <v-container fluid id="contacto" class="py-8" style="background-color: #041845;">
        <v-container>
          <v-row justify="center">
            <v-col cols="12" md="8" class="text-center">
              ...
              <div class="d-flex flex-wrap justify-center gap-4">
                ...
                <v-btn
                  ...
                  size="x-large"
                  color="white"
                  style="text-transform: none; color: #041845;"
                  class="px-8"
                >
                  Cómo Llegar
                </v-btn>
    ...
    <!-- Footer -->
    <v-footer style="background-color: #1a1a1a; color: white;" class="py-8">
      <v-container>
        <v-row>
